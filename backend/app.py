...
app = Flask(__name__)
app.secret_key = 'sapyaite_secret_key_2024' #cambiar por una clave segura en producción(la clave se usa para firmar las cookies de sesión, no debe ser pública ni predecible)
...
CORS(app, supports_credentials=True, origins=[
    ...
    "http://localhost:8080",
    "http://127.0.0.1:8080",
    "null"   # Necesario cuando se abren archivos HTML directamente con file://
])
